...
class UserController:
    ...
    @put("/{user_id}/news/{news_id}/liked/?")
    def update_news_liked(self, user_id: int, news_id: int, request: IsLiked):
        return self.user_service.update_news_liked(user_id, news_id, request)
    ...
    @put("/{user_id}/tests/{test_id}/liked/?")
    def update_test_liked(self, user_id: int, test_id: int, request: IsLiked):
        return self.user_service.update_test_liked(user_id, test_id, request)
