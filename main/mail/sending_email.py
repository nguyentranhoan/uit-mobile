    ...
    <html>
      ...
      <body>
        <p>Hi!<br>
           ...
           <br>Click here <a href="http://60dd6eb9.ngrok.io/reset/password/successful">LINK</a> to reset password.</br>
        </p>
      </body>
    </html>
    """
...
def validate_user_mail(to: EmailStr):
    ...
    <html>
      ...
      <body>
        <p>Hi!<br>
           MESSAGE FROM PERSONAL TESTS APP<br>
           Click here <a href="http://60dd6eb9.ngrok.io/register/successful">LINK</a> to register user.
        </p>
      </body>
    </html>
    """
