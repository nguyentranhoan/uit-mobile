...
#define PG_VERSION "11.5 (Debian 11.5-1+deb10u1)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 110005

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 11.5 (Debian 11.5-1+deb10u1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 8.3.0-6) 8.3.0, 64-bit"
